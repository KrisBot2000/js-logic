...
console.log(bigBird("huge"));
console.log(bigBird("pig"));
...
console.log(isEqual("you", "you"));
console.log(isEqual("me", "you"));
...
console.log(notEqual("me", "you"));
console.log(notEqual("you", "you"));
